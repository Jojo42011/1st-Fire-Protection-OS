...
| `MOONSHOT_API_KEY` | The Harness coder flips to **Kimi K3** (writes each new agent's real code module; escalates to the **K3 swarm** on complex builds via `MOONSHOT_SWARM`; without it, Claude/GPT code, then a template) |
