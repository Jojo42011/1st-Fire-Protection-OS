 ...
 *   GET  /api/partner/cross-sell   -> Northstar commercial customers as security leads
...
// A Northstar tech flags a commercial site for VDS while on the job.
...
<body><span class="badge">NORTHSTAR → VDS</span><h1>Flag a site for cameras</h1><p>See a commercial building with old or no cameras while you're on the job? Flag it. It goes straight to VDS as a warm security lead.</p>
